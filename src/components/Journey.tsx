    ...
    <section className="mt-20">
      <section className="flex flex-col gap-5 ">
        <article className="flex relative h-96">
          <div className={`sm:absolute left-0 -top-3 p-5 bg-white ${theme === "dark" && "text-greenLight"} shadow-lg rounded-md w-full sm:w-1/2 md:w-1/3 transform -rotate-3 transition-all duration-300 hover:rotate-0 hover:scale-105 hover:z-10`}>
            <Image
              src="/award.jpg"
              alt="First runners up award"
              className="w-full rounded-md object-cover sm:object-none md:object-cover aspect-square h-72"
              width={300}
              height={300}
            />
          ...
          <div className={`hidden md:block md:absolute left-1/3 top-4 p-5 bg-white ${theme === "dark" && "text-greenLight"} shadow-lg rounded-md w-full md:w-1/3 transform md:rotate-1 transition-all duration-300 hover:rotate-0 hover:scale-105 hover:z-10`}>
            <Image
              src="/phot.jpg"
          ...
          <div className={`hidden sm:block sm:absolute right-0 -top-6 p-5 bg-white ${theme === "dark" && "text-greenLight"} shadow-lg rounded-md w-full sm:w-1/2 md:w-1/3 transform md:rotate-3 transition-all duration-300 hover:rotate-0 hover:scale-105 hover:z-10`}>
            <Image
              src="/community.jpg"
        ...
        <article className="hidden md:flex flex-col md:flex-row relative h-96">
          <div className={`md:absolute left-0 -top-6 p-5 bg-white ${theme === "dark" && "text-greenLight"} shadow-lg rounded-md w-full md:w-1/3 transform md:rotate-12 transition-all duration-300 hover:rotate-0 hover:scale-105 hover:z-10`}>
            <Image
              src="/me-mentor.jpg"
          ...
          <div className={`md:absolute left-1/3 top-6 p-5 bg-white ${theme === "dark" && "text-greenLight"} shadow-lg rounded-md w-full md:w-1/3 transform -rotate-3 transition-all duration-300 hover:rotate-0 hover:scale-105 hover:z-10`}>
            <Image
              src="/hackathon.jpg"
              alt="hackathon"
              className="w-full rounded-md object-cover sm:object-none md:object-cover aspect-square h-72"
          ...
          <div className={`md:absolute right-0 -top-8 p-5 bg-white ${theme === "dark" && "text-greenLight"} shadow-lg rounded-md w-full md:w-1/3 transform -rotate-1 transition-all duration-300 hover:rotate-0 hover:scale-105 hover:z-10`}>
            <Image
              src="/taji.jpg"
      ...
      <section className="py-20 flex flex-col gap-5">
       <AnimatedBody
         ...
         className={"text-sm md:text-base leading-8"}
          />
          <article className="flex flex-col md:flex-row relative h-96 my-20">
          <div className={`sm:absolute left-0 -top-3 p-5 bg-white ${theme === "dark" && "text-greenLight"} shadow-lg rounded-md w-full sm:w-1/2 md:w-1/3 transform -rotate-3 transition-all duration-300 hover:rotate-0 hover:scale-105 hover:z-10`}>
            <Image
              src="/moringa.jpg"
          ...
          <div className={`hidden md:block md:absolute left-1/3 top-4 p-5 bg-white ${theme === "dark" && "text-greenLight"} shadow-lg rounded-md w-full md:w-1/3 transform rotate-1 transition-all duration-300 hover:rotate-0 hover:scale-105 hover:z-10`}>
            <Image
              src="/meet.jpg"
              alt="Maurice at a meet up"
              className="w-full rounded-md object-cover sm:object-none md:object-cover aspect-square h-72"
          ...
          <div className={`hidden sm:block sm:absolute right-0 -top-6 p-5 bg-white ${theme === "dark" && "text-greenLight"} shadow-lg rounded-md w-full sm:w-1/2 md:w-1/3 transform rotate-3 transition-all duration-300 hover:rotate-0 hover:scale-105 hover:z-10`}>
            <Image
              src="/present.jpg"
              alt="Maurice first hackathon"
              className="w-full rounded-md object-cover sm:object-none md:object-cover aspect-square h-72"
